...
<html lang="es">
    <head>
        ...
        <title>
            ...
            <?php echo (!is_null($main_title)) ? $main_title : "Sistema de Reportes de Desarrollo Profesional Continuo a Distancia" ?>
        </title>
                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <img height="80px" class="cores-logo" src="<?php echo base_url(); ?>assets/login/die.png">
                            <img height="80px" class="logo_responsive" src="<?php echo base_url(); ?>assets/tablero_tpl/img/ces.png" />
