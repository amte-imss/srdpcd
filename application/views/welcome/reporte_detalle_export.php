                ...
                <tbody>
                    ...
                    foreach ($datos as $key_c => $dato) {
                        echo "<tr>
                                ...
                                <td>".$dato['imal_fecha_inicio_curso']."</td>
                                <td>".$dato['imal_fecha_fin_curso']."</td>
                                ...
                                <td>".(!is_null($dato['imal_folio_certificado']) and !empty($dato['imal_folio_certificado']) ? 'Aprobado' : '')."</td>
                            </tr>";
